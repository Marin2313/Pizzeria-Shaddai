...
if (!$conn) {
	...
	echo "<div class='alert alert-warning mt-4' role='alert'>
					...
					<p><a href='login.php'>Por favor inicia sesion aqui</a></p>
				</div>";
	} else {	
	...
	*/
	...
	if (mysqli_query($conn, $query)) {
		echo "<div class='alert alert-success mt-4' role='alert'><h3>Tu cuenta a sido creada!</h3>
		<a class='btn btn-outline-primary' href='login.php' role='button'>Inica sesion</a></div>";		
		} else {
